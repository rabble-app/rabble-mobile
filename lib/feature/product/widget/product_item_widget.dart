...
class ProductItemWidget extends StatelessWidget {
  ...
  ProductItemWidget(this.productDetail,
      {Key? key,
      this.businessDetail,
      this.isHorizontal,
      this.voidCallBack,
  ...
  Widget build(BuildContext context) {
    return CubitProvider<RabbleBaseState, ProductDetailCubit>(
        create: (BuildContext context) =>
            ProductDetailCubit()..fetchSingleProductExist(productDetail.id!),
                                            ...
                                            child: Container(
                                              ...
                                              decoration: ContainerDecoration
                                                  .boxDecoration(
                                                      ...
                                                      width: 2,
                                                      radius: 100),
                                              child: Assets.svgs.portioned_icon
                                                  .svg(),
                                            ),
                                          ),
                                        ),
                                                  ...
                                                  child: Center(
                                                    child: RabbleText
                                                      ...
                                                      text: productDetail
                                                              ...
                                                              0
                                                          ? '0 left'
                                                          : '${productDetail.thresholdQuantity! - qtySnapshot.data!.toInt()} left',
                                                      textAlign:
                                                          TextAlign.center,
                                                      fontWeight:
                                                          FontWeight.w600,
                                        ...
                                        qtyCallBack: (qty) async {
                                          if (productDetail.type ==
                                            ...
                                            if (qty <=
                                              ...
                                              print("qty $qty");
                                              print(
                                                  "productDetail.thresholdQuantity ${productDetail.thresholdQuantity}");
