                                ...
                                builder: (context, expandedTeamInfoSnapshot) {
                                  return Column(
                                    ...
                                    children: [
                                            ...
                                            child: SizedBox(
                                                ...
                                                height:
                                                    MediaQuery.of(context).size.height *
                                                        0.4,
                                                child: productDetail.thresholdQuantity! - productDetailSnapShot.data!.qty! <= 0 &&
                                                        productDetail.type ==
                                                    ...
                                                    : RabbleImageLoader(imageUrl:  productDetail.imageUrl ?? '',

                                                    fit: BoxFit.cover,isRound: false)),
                                          ),
                                          if (productDetail.type ==
                                              'PORTIONED_SINGLE_PRODUCT' &&
                                              productDetail.thresholdQuantity! - productDetailSnapShot.data!.qty! <=
                                                  0)
                                            Positioned(
                                              right: 0,
                                              top: 0,
                                      ...
                                      productDetail.type == 'PORTIONED_SINGLE_PRODUCT' &&
                                              productDetailSnapShot.data != null &&
                                              productDetailSnapShot.data!.qty == 0
                                          ? Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  GestureDetector(
                                                    onTap: (){
                                                      bloc.expandedTeamInfoSubject$.sink.add(!expandedTeamInfoSnapshot.data!);
                                                    },
                                                    child: Container(
                                                      padding: PagePadding.onlyRight(1.w),
                                                      child: Icon(
                                                        !expandedTeamInfoSnapshot.data!?  Icons.keyboard_arrow_down_outlined :  Icons.keyboard_arrow_up_outlined,
                                              ...
                                              ? Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        height:
                                                            context.allWidth * 0.06,
                                                        width:
                                                            context.allWidth * 0.13,
                                                        margin: PagePadding.onlyTop(
                                                            1.w),
                                                        decoration:
                                                            ContainerDecoration
                                                                .boxDecoration(
                                      ...
                                      if (productDetail.type ==
                                          'PORTIONED_SINGLE_PRODUCT' && expandedTeamInfoSnapshot.data!)
                                        BehaviorSubjectBuilder<List<TempBoxData>>(
                                            subject: bloc.purchasedUserListSubject$,
                                            builder:
                                                (context, purchaseUserSnapshot) {
                                              return Container(
                                                margin: PagePadding.horizontalSymmetric(3.w),
                                                child: PortionedProductTeamListWidget(
                                                  partionedProductsList: productDetail
                                                              .partionedProducts !=
                                                          null
                                                      ? productDetail
                                                          .partionedProducts!
                                                      : [],
                                                  purchaseUser:
                                                      purchaseUserSnapshot.hasData
                                                          ? purchaseUserSnapshot.data!
                                                          : [],
                                                  totalItems:
                                                      productDetail.totalThresholdQuantity!,
                                                ),
                                              );
                                            }),
                                      if (productDetail.type ==
                                      ...
                                      Container(
                                        ...
                                        padding:
                                            PagePadding.custom(1.w, 1.w, 4.w, 1.w),
                                        child: Column(
                                          mainAxisAlignment:
                                              MainAxisAlignment.start,
                                          crossAxisAlignment:
                                          ...
                                          children: [
                                            if (productDetailSnapShot.hasData)
                                              if (productDetail.type ==
                                                  'PORTIONED_SINGLE_PRODUCT')
                                                Container(
                                                  height: context.allWidth * 0.16,
                                                  padding: PagePadding
                                                      .horizontalSymmetric(1.w),
                                                  margin: PagePadding
                                                      .horizontalSymmetric(2.w),
                                                  decoration: ContainerDecoration
                                                      .boxDecoration(
                                      ...
                                      BehaviorSubjectBuilder<List<ProductDetail>>(
                                          subject: bloc.moreProductListSubject$,
