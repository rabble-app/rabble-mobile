...
import '../../product/portioned_product_widget.dart';
import 'complete_threshold_shimmer.dart';

class CompleteThresholdView extends StatelessWidget {
  CompleteThresholdView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return CubitProvider<RabbleBaseState, ThresholdViewCubit>(
        create: (Context) => ThresholdViewCubit(teamId: data['teamId']),
                                                                  ...
                                                                  children: [
                                                                    BehaviorSubjectBuilder<
                                                                        ...
                                                                        builder:
                                                                            (context,
                                                                                requestSnap) {
                                                                          return userDataSnap.data!.id != teamDataSnap.data!.hostId
                                                                              ? MemberDescriptionViewComplete(
                                                                                  showMemmbers: teamDataSnap.data!.members!.length > 0,
                                                                                  avatar: teamDataSnap.data!.host!.imageUrl ?? '',
                                                                                  user: '${teamDataSnap.data!.host!.firstName ?? ''} ${teamDataSnap.data!.host!.lastName ?? ''}',
                                                                                  firstName: teamDataSnap.data!.host!.firstName ?? '',
                                                                                  lastName: teamDataSnap.data!.host!.lastName ?? '',
                                                                                  associateMembers: teamDataSnap.data!.members!,
                                                                              ...
                                                                              : MemberDescriptionViewComplete(
                                                                                  showMemmbers: teamDataSnap.data!.members!.length > 0 && teamDataSnap.data!.members!.where((element) => element.userId != userDataSnap.data!.id) != null,
                                                                                  avatar: teamDataSnap.data!.host!.imageUrl ?? '',
                                                                                  user: '${teamDataSnap.data!.host!.firstName ?? ''} ${teamDataSnap.data!.host!.lastName ?? ''}',
                                                                                  firstName: teamDataSnap.data!.host!.firstName ?? '',
                                                                                  lastName: teamDataSnap.data!.host!.lastName ?? '',
                                                                    ...
                                                                    BehaviorSubjectBuilder<RequestSendData>(
                                                                        subject: bloc.isMyRequest,
                                                                        builder: (context, requestSnap) {
                                                                          if ((requestSnap.hasData && requestSnap.data != null && requestSnap.data!.status == 'APPROVED') || teamDataSnap.data!.members!.where((element) => element.userId == userDataSnap.data!.id).isNotEmpty) {
                                                                            return GestureDetector(
                                                                              onTap:
                                                                                  () {
                                                                                Map map =
                                                                                {
                                                                                  'teamName': teamDataSnap
                                                                                      .data!
                                                                                      .name,
                                                                                  'teamId': teamDataSnap
                                                                                      .data!
                                                                                      ...
                                                                                      if (currentOrderSnap.data!.partionedProducts!.isNotEmpty)
                                                                                        BehaviorSubjectBuilder<List<List<TempBoxData>>>(
                                                                                            ...
                                                                                            builder: (BuildContext context, purchaseUserSnapshot) {
                                                                                              print('purchaseUserSnapshot ${purchaseUserSnapshot.data!.length}');
                                                                                              return PortionedProductWidget(
                                                                                                heading: '${currentOrderSnap.data!.partionedProducts!.first.product!.orderUnit!} of ${currentOrderSnap.data!.partionedProducts!.first.product!.unitsOfMeasure!.toLowerCase().substring(0, 3)} ${currentOrderSnap.data!.partionedProducts!.first.product!.orderSubUnit!.toLowerCase()}s',
                                                                                                        ...
                                                                                                        builder: (context, s) {
                                                                                                          return Container(
                                                                                                            ...
                                                                                                            child: BasketWidget(
                                                                                                              ...
                                                                                                              basket: getMyOrder(currentOrderSnap.data!.basket!, userDataSnap.data!.id),
                                                                                            ...
                                                                                            Container(
                                                                                              ...
                                                                                              child: ListView.builder(
                                                                                                  ...
                                                                                                  itemBuilder: (context, index) {
                                                                                                    ...
                                                                                                    return otherMateData.userId != userDataSnap.data!.id && getQuantity(currentOrderSnap.data!.basket!, otherMateData.userId)
                                                                                                        ? StreamBuilder<bool>(
                                                                                                            initialData: false,
                                                                                                            stream: _expandableStream.stream,
                                                                                                            builder: (context, s) {
                                                                                                              return BasketWidget(
                                                                                                                ...
                                                                                                                basket: getMyOrder(currentOrderSnap.data!.basket!, otherMateData.userId),
                                                                                                                callBackExpanded: (val) {
                                                                                                                  _expandableStream.sink.add(val ? false : true);
                                                                                                                },
                                                                                                              );
  ...
  getOtherMatesOrder(List<Basket> list, String? id) {
    return list.where((element) => element.userId == id).toList();
  }

  bool getQuantity(List<Basket> list, String? userId) {
    Basket? member = list.firstWhere(
        (element) => element.quantity! > 0 && userId == element.userId,
        orElse: () => Basket());
    if (member.id != null) {
      print("asda");
