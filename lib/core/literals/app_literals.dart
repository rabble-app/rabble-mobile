...
const kTC = 'By proceeding you agree to the';
const kNext = 'Next';
const kLogin = 'Login';
const kEdit = 'Edit';
const kTermsAndConditions = ' Terms and Conditions';
const kJoinTeamRequest = 'Join Team Request';
const kAbTitle = 'Fremont wine group';
const kTK = 'Tamara Khan';
const kBackToBasket = 'Back to Basket';
const k44 = '+44';
const kManageMyTeam = 'Manage My Team';
const kYS = 'Your Subscription';
const kInviateContactFremont = 'Invite a contact to Fremont Wine Group';
const kInviateContact = 'Invite Contacts';
const kHost = 'Host: ';
const kContactsSelected = 'Contacts Selected';
const kHost2 = 'Host';
const kPayGBP164 = 'Pay (GBP 164.00)';
const kNewToRabble = 'New to Rabble?';
const kAlreadyMember = 'Already a Member? ';
const kRegisterNow = ' Register Now';
const kHollyK = 'Holly K';
const kShare = 'Share';
...
const kFloorUnit = 'Floor/Unit#';
const kSetLocation = 'Set location';
const k157 = '157%';
const kFAQs = 'FAQs';
const kRateRabble = 'Rate Rabble';
const kUpdateRABBLE = 'Update RABBLE';
const kTermsofUse = 'Terms of Use';
const kPrivacyPolicy = 'Privacy Policy';
const kContactUsFeedback = 'Contact us';
const kProvideYourFeedback = 'Provide your feedback';
const kSetting = 'Settings';
const kManageYourCard = 'Manage your cards';
const kLEGALHELP = 'LEGAL & HELP';
const kYouCantChangeEmail = 'You can’t change your login email.';
const kCancel = 'Cancel';
const kNoProductFound = 'No Product Found!';
const kNoBuygintTeamNear = 'No Buying Team Near';
const kDetails = 'Details';
const khtl = '@htl';
const kProdcuer = 'Producer';
const kTypeToSearch = 'Type to search...';
const kSearch = 'Search';
const kChooseyourItemsfrom = 'Choose your Items from';
const kChooseYourProdcuerForYourTeam = 'Choose a Producer for your Team';
const kNDeliver = 'Next Delivery Date:';
const kDate = ' 27th February';
const kChooseyouritems = 'Choose your first item';
const kCD = ' Collection Address:';
const kYB = ' Your Subscription';
const KUO = ' Upcoming Order';
const k3Items = ' 3 items';
const kRequestedToJoinTeam = 'Requested to join team';
const k240 = '£240';
const k320 = '£320';
const k150 = '£150';
const k700 = '£700';
...
const k75 = '£75';
const kKateE = 'Kate.E';
const kConfirmYourOrder = 'Confirm your order';
const kPName = 'Product Name';
const kMaxB = 'Max.B';
const KTowards = 'towards';
const kTowards = 'towards';
const k500 = '£500';
const kYourDetails = 'Your Details';
const kTellYourName = 'Let the community know who you are';
const kSignUp = 'Sign up';
const kSignUpHint = 'Join the Rabble community';
const kTeamInfo = 'Team Info';
const kCheckout = 'Checkout';
const kProceedCreateTeam = 'Proceed to Create a Team';
const kMinium = 'minimum by 3 member.';
const kTo = 'to pass minimum.';
const kBuyingTeamNearMe = '$kBuyingTeams Near You';
const kPN = 'Phone number';
...
const kCardNumber = 'Card number';
const k44444 = '4444 4444 4444 4444';
const kPay = 'Pay';
const kCVVStar = '***';
const kExpiryDate = '05/23';
const kCardDetail = 'Card Details';
const kAreYouOver18 = 'Are you over 18?';
const kAddNewCard = 'Add New Card';
const kAddANewCard = 'Add a New Card';
const kProductDetail = 'Product Details';
const kQRCode = 'QR Code';

const kDateThu = 'Thu, Mar 18, 2023';
const kEnding = 'Ending in:';
const kLastTimeUsed = 'Last time used:';
const kN8846 = ' ....8846';
const kOrPayByCardBelow = 'Or pay by card below';
...
const kLoginHint = 'Sign in and meet the producers';
...
const kOTPVerification = 'OTP verification';
const kOTPVerificationHint = 'Check your messages to verify the code.';
const kBlackLines = 'Blacklines';
const kFinePP = 'Find people and products';
const kViewAll = 'View all';
const kJoinNow = 'Join Now';
const kVerify = 'Verify';
const kResendCode = 'Resend Code';
const kResendCodeIn = 'Resend Code in';
const kMyRabble = 'My Rabble';
const kBuyingTeams = 'Buying Teams';
const kRabbleHubs = 'Rabble Hubs';
const kBuyingTeamsForBlackLines = 'Buying teams for Black Lines';
const kMyPostCode = 'My Postcode';
const kPostCode = 'PostCode';
const kBuildingNumber = 'Building Number';
const kAdd = 'Add';
const kYour = 'Your';
const kCity = 'City';
const kTryAgain = 'Try Again';
const kNewYork = 'NewYork';
...
const kAddPostcode = 'Add Postcode';
const kRequest = 'Requests';
...
const kSave = 'Save Changes';
const kViewYourBasket = 'View Your Basket';
const kChangeProfilePhoto = 'Change Profile Photo';
const kEditProfile = 'Edit Profile';
const kUpdateChanges = 'Update Changes';
const kAddressLine = 'Address line 1';
const kAddressDetail = 'Street - 14, Block west';
const kRequestToJoin = 'Request To Join';
const kShowingBuyingTeamNearYou = 'Show Buying Teams Near Me';
const kAddToTeam = 'Add to team';
...
const kEditTeamName = 'Edit Team Name';
const kEditTeamIntroduction = 'Edit Team introduction';
const kNameGroup = 'Name Group';
const kChooseGroup = 'Creating a Team Name';
...
const kQRCODETORECEIVEORDER = 'QR Code to Receive Order';
const kJoinRabbleHub = 'Join Rabble Hub';
const kOrderSummary = 'Order summary';
const kDeliveryView = 'Choose delivery';
const kReviewPayment = 'Review Payment';
const kOver18 = 'Are you over 18?';
const kPaymentMethod = 'Payment Method';
const kTotalPrice = 'Total Price';
const kIncludingVAT = 'Including VAT';
const kNextDelivery = 'Next Delivery Date';
const kCollectionAddress = 'Collection Address';
const kThresholdMet = 'Minimum Order Met';
...
const kSkipNextDelivery = 'Skip Next Delivery';
const kQuitTeam = 'Quit Team';
...
const kOrderNo = 'Order Number: ';
const kFreeDelivery = 'Free Delivery';
const kTotal = 'Total';
const kNumber = 'Number';
const kNearByLocation = 'NearBy Location';
const kType = 'Type';
...
const kTeamSetup = 'Team Setup';
const kOnceWeek = 'Once a week';
const kWeekly = 'Weekly';
const kOnce2Week = 'Once every 2 week';
const kEveryMonth = 'Once a month';
const kEvery2Months = 'Once every 2 months';
const kEvery2Weeks = 'Every 2 Weeks';
const kCustom = 'Custom';
const kCustomFrequency = 'Custom Frequency';
const kConfirmFreq = 'Confirm Frequency';
const kSeeMore = 'See more';
const kSeeLess = 'See Less';
const kOnceWeekN = '604800';
const kOnce2WeekN = '1209600';
const kEveryMonthN = '2419200';
const kEvery2MonthN = '4838400';
const kAddProduct = 'Add Products';

const kTeamStrength = 'Team Strength';
const kVans = 'Delivery vans Prevented';
const kAmountSaved = 'Saved';
const kTeamSettings = 'Team Settings';
const kManageMembers = 'Manage Members';
const kManageMTeamMembers = 'Manage Team Members';
...
const kPaymentSuccess = 'Payment Succeed';
const kPaymentFailure = 'Payment Failure';
const kShipmentSkipped = 'Shipment Skipped';

const kPrivateGrp = 'Make Group Private';
const kNudgeToCollect = 'Nudge team to Collect';
const kShipmentFrq = 'Shipment Frequency -';
const kEditShipmentFrq = 'Edit Shipment Frequency';
const kAddCustomShipmentFrq = 'Add Custom Frequency';
const kAdjustDate = 'Adjust Next Shipment Date';
const kEditNextShipmentDate = 'Edit Next Shipment Date';
const kEditNewShipmentDate = 'Edit New Shipment Date';
const kNudgeToUpdate = 'Nudge to update';
const kNudge = 'Nudge';
const kMay2023 = 'May 2023';

// dynamic Strings
const sBlackLines = 'blacklines';
const sBlackLinesUrl = 'blacklinesdrinks.com/';
const sMeetTP = 'Meet the Producers';
const sLamiri = 'Lamiri Harissa';
const sLamiriStatement =
    'Harissa that brings people together and\ncelebrate Tunisia’s culturally rich cuisine.';
const sBuyingTeamIn = 'Buying Teams In ';
const sFremontWineGroup = 'Fremont wine group';
const sTeamAbc = 'Team Abc';
const sJanny = 'Janny';
const sJamesMarthon = 'James Marthon';
const sAlisonHolme = 'Alison Holme';
...
const sAddress = ' 147a Southgate Road, N169JU';
const sShipTo = '143 Albion Road';
const sDeliverMonths = '5 Months';
const sVisaDetails = 'Visa Ending in:';
...
const cUrbanist = 'Urbanist';
const cGosha = 'Gosha';
const cPoppins = 'Poppin';
const cPoppinItalic = 'PoppinItalic';
