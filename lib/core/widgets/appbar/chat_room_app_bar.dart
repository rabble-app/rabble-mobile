...
class ChatRoomAppbar extends StatelessWidget {
  ...
  const ChatRoomAppbar({
    ...
    this.hideLeading,
    this.leadingWidth, required this.memeberList, required this.callBack,
  }) : super(key: key);
              ...
              child: Container(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      List<String> text = '${memberData.user!.firstName??''} ${memberData.user!.lastName??''}'.split(' ');
                      ...
                      if (index <3) {
                        return  memberData.user!.imageUrl!.isNotEmpty?Container(
