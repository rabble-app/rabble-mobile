...
class PagePadding extends EdgeInsets {
  ...
  const PagePadding.customHorizontalVerticalSymmetric(double horizontalPaddingValue, double verticalPaddingValue)
      : super.symmetric(horizontal: horizontalPaddingValue, vertical: verticalPaddingValue);
