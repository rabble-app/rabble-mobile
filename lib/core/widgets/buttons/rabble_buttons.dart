        ...
        switch (decoration) {
          case ButtonDecoration.outlined:
            return RabbleTheme.of(context)
                ...
                .outlinedButtonStyle
                .copyWith(
                  textStyle: MaterialStateProperty.all(getTextTheme(context,labelColor)),
          ...
          case ButtonDecoration.none:
            return RabbleTheme.of(context).buttonTheme.textButtonStyle.copyWith(
                  textStyle: MaterialStateProperty.all(getTextTheme(context,labelColor)),
                  padding: MaterialStateProperty.all<EdgeInsetsGeometry>(
                      getButtonPadding(context)),
                );
        ...
        switch (decoration) {
          ...
          case ButtonDecoration.filled:
            return RabbleTheme.of(context)
                ...
                .copyWith(
                  overlayColor:
                      MaterialStateProperty.all(APPColors.appPrimaryColor),
                  foregroundColor:
                      MaterialStateProperty.all(APPColors.appPrimaryColor),
                  backgroundColor: MaterialStatePropertyAll(bgColor ?? APPColors.appGrey),
                  textStyle: MaterialStateProperty.all(getTextTheme(context,labelColor)),
                  shape: MaterialStateProperty.all<OutlinedBorder>(
                    RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(8),
