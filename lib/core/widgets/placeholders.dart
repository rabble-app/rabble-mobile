...
abstract class ImageAssetPlaceholder extends Placeholder {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      color: color ?? RabbleTheme.of(context).colorTheme.primary,
      child: buildContent(context),
    );
  }
...
class RabbleOopsErrorPlaceholder extends SvgAssetPlaceholder {
  const RabbleOopsErrorPlaceholder() : super('assets/icons/ohno_oops.svg');
}
...
class RabbleGenericPlaceholder extends StatelessWidget {
  final bool circular;

  const RabbleGenericPlaceholder() : this.circular = false;
  const RabbleGenericPlaceholder.circular() : this.circular = true;
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: const ExactAssetImage('assets/icons/logo-white.png'),
          fit: BoxFit.contain,
        ),
      ),
    );
